...
// ==========================================
const CONFIG = {
    STORE_NAME: 'yoyogiuehara',                // APIに送信する店舗識別子
    STORE_KEYWORD: '代々木上原',               // ログ表示用
    SEARCH_QUERY: 'from:noreply@em.hacomono.jp subject:hallel',  // Gmail検索クエリ
    INCLUDE_KEYWORD: '代々木上原店',           // 必須キーワード
    EXCLUDE_KEYWORDS: ['半蔵門店', '渋谷店', '恵比寿店', '中目黒店'],  // 除外キーワード
    DEFAULT_ROOM: 'パーソナルジム',            // デフォルト部屋名
    API_URL: 'https://hallel-shibuya.vercel.app/api/gas/webhook',  // API URL
    API_KEY: 'Wh00k@2025!Secure$Token#ABC123XYZ',  // API認証キー
    CALENDAR_ID: null,                         // カレンダーID（nullなら同期なし）
    LABEL_NAME: 'HALLEL_処理済み_代々木上原',  // Gmailラベル名
};
