...
// ==========================================
const CONFIG = {
    STORE_NAME: 'nakameguro',                  // APIに送信する店舗識別子
    STORE_KEYWORD: '中目黒',                   // ログ表示用
    SEARCH_QUERY: 'from:noreply@em.hacomono.jp subject:hallel',  // Gmail検索クエリ
    INCLUDE_KEYWORD: '中目黒店',               // 必須キーワード
    EXCLUDE_KEYWORDS: ['半蔵門店', '渋谷店', '恵比寿店', '代々木上原店'],  // 除外キーワード
    DEFAULT_ROOM: 'フリーウエイトエリア',      // デフォルト部屋名
    ...
    LABEL_NAME: 'HALLEL_処理済み_中目黒',      // Gmailラベル名
};
