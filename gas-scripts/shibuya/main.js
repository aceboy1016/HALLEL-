...
// ==========================================
const CONFIG = {
    STORE_NAME: 'shibuya',                     // APIに送信する店舗識別子
    STORE_KEYWORD: '渋谷',                     // ログ表示用
    SEARCH_QUERY: 'from:noreply@em.hacomono.jp subject:hallel',  // Gmail検索クエリ
    INCLUDE_KEYWORD: '渋谷店',                 // 必須キーワード
    EXCLUDE_KEYWORDS: ['半蔵門店', '恵比寿店', '中目黒店', '代々木上原店'],  // 除外キーワード
    DEFAULT_ROOM: 'STUDIO 1',                  // デフォルト部屋名
    ...
    LABEL_NAME: 'HALLEL_処理済み_渋谷',        // Gmailラベル名
};
